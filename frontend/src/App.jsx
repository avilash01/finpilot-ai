  ...
  const [chatMessages, setChatMessages] = useState([
    {
      role: "assistant",
      content:
        "Hello 👋 I am FinPilot AI. Ask me anything about your expenses.",
    },
  ]);
        ...
        >
          ...
          >
            ...
            <h2
              style={{
                color:
                  (analytics.total_spending || 0) > budget
                    ? "#ef4444"
                    : "#22c55e",
              }}
            >
            ...
            >
              {expenses.map((expense, index) => (
                ...
                >
                  ...
                  <p>
                    <b>Pattern:</b> {expense.pattern}
                  </p>

                  <p>
                    <b>Saving Tip:</b> {expense.saving_tip}
                  </p>
